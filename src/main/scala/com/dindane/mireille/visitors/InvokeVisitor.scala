...
import main.scala.com.dindane.mireille.models.InvokeCall

abstract class InvokeVisitor(className: String, invokeOpcode: Int) extends ClassVisitor(Opcodes.ASM4) {

  val calls: mutable.MutableList[InvokeCall] = mutable.MutableList.empty
